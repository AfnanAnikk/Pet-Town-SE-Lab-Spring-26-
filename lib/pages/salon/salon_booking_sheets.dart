...
class _PetSpeciesSheetState extends State<PetSpeciesSheet> {
  ...
  final speciesList = [
    ...
    {'name': 'Horse', 'icon': Icons.bedroom_baby},
...
class ServiceSheet extends StatefulWidget {
  ...
  const ServiceSheet({super.key, this.initialService});
...
class _ServiceSheetState extends State<ServiceSheet> {
  ...
  void initState() {
    super.initState();
    _selected = widget.initialService;
  }

  final services = [
    {'name': 'Grooming & Bath', 'icon': Icons.bathtub_outlined},
    {'name': 'Haircut & Styling', 'icon': Icons.content_cut_outlined},
    {'name': 'Nail Trimming', 'icon': Icons.back_hand_outlined},
    {'name': 'Spa & Massage', 'icon': Icons.spa_outlined},
    {'name': 'Flea & Tick Treatment', 'icon': Icons.bug_report_outlined},
    {'name': 'Teeth Cleaning', 'icon': Icons.health_and_safety_outlined},
  ];
              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      childAspectRatio: 2.2, // adjusted for longer text
                      crossAxisSpacing: 12,
                      mainAxisSpacing: 12,
                    ),
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              maxLines: 4,
              decoration: InputDecoration(
                hintText: 'Briefly describe your instructions for the groomer...',
